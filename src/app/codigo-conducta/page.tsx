...
export default async function CodigoConductaPage() {
  ...
  return (
    <main style={{ background: '#F3EFE7', minHeight: '100vh', padding: '4rem 1.5rem' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        >
          <strong>Borrador &mdash; no validado legalmente.</strong> Este documento es un borrador
          de trabajo. Debe ser revisado antes de entrar en vigor con usuarios reales.
        </div>
